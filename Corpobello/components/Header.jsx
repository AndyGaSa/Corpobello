...
export default function Header({ username }) {
  ...
  if (username && username === 'undefined') {
    userButtonMobile = (
      <Link href="/login">
        <div className="mobile-menu__item">
          <a
            href="replace"
            className={allValues.login ? allValues.login : 'notActual anchor'}
          >
            INICIAR SESIÓN
          </a>
        </div>
    ...
    userButton = (
      <Link href="/login">
        <a href="replace" className={`anchor ${allValues.login}`}>
          INICIAR SESIÓN
        </a>
      </Link>
    );
  ...
  return (
    <header>
      <nav className={homeOrNot}>
        ...
        <Link href="/services">
          <a href="replace" className={`anchor ${allValues.services}`}>
            SERVICIOS
          </a>
        </Link>
        <Link href="/reserves">
          <a href="replace" className={`anchor ${allValues.reserves}`}>
            RESERVA
          </a>
        </Link>
        <Link href="/events">
          <a href="replace" className={`anchor ${allValues.events}`}>
            EVENTOS
          </a>
        </Link>
        <Link href="/contact">
          <a href="replace" className={`anchor ${allValues.contact}`}>
            CONTACTO
          </a>
        </Link>
        {userButton}
            ...
            <Link href="/">
              <div className="mobile-menu__item">
                <a
                  href="replace"
                  className={
                    allValues.home ? allValues.home : 'notActual anchor'
                  }
                >
                  INICIO
                </a>
            ...
            <Link href="/services">
              <div className="mobile-menu__item">
                <a
                  href="replace"
                  className={
                    allValues.services ? allValues.services : 'notActual anchor'
                  }
                >
                  SERVICIOS
                </a>
            ...
            <Link href="/reserves">
              <div className="mobile-menu__item">
                <a
                  href="replace"
                  className={
                    allValues.reserves ? allValues.reserves : 'notActual anchor'
                  }
                >
                  RESERVA
                </a>
            ...
            <Link href="/events">
              <div className="mobile-menu__item">
                <a
                  href="replace"
                  className={
                    allValues.events ? allValues.events : 'notActual anchor'
                  }
                >
                  EVENTOS
                </a>
            ...
            <Link href="/contact">
              <div className="mobile-menu__item">
                <a
                  href="replace"
                  className={
                    allValues.contact ? allValues.contact : 'notActual anchor'
                  }
                >
                  CONTACTO
                </a>
